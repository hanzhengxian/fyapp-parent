...
public class ImportExcelPoi {
	 ...
	 * 
	 */
	public void expExcel_2007( String fileName,
...
//			cellStyle_date.setDataFormat(HSSFDataFormat.getBuiltinFormat("yyyy/mm/dd"));
			cellStyle_date.setDataFormat(format.getFormat("yyyy-MM-dd HH:mm:ss"));
			...
			xssf_w_sheet.setColumnWidth((short) 1, (short) 5000); 
			xssf_w_sheet.setColumnWidth((short) 2, (short) 5000); 
			xssf_w_sheet.autoSizeColumn(3);
			xssf_w_sheet.autoSizeColumn(4);
			xssf_w_sheet.autoSizeColumn(5);
			xssf_w_sheet.autoSizeColumn(6);
			xssf_w_sheet.autoSizeColumn(7);
			xssf_w_sheet.setColumnWidth((short) 8, (short) 5000); 
			xssf_w_sheet.setColumnWidth((short) 9, (short) 5000); 
			xssf_w_sheet.setColumnWidth((short) 10, (short) 5000); 
			xssf_w_sheet.setColumnWidth((short) 11, (short) 5000); 
			xssf_w_sheet.autoSizeColumn(12);
			xssf_w_sheet.autoSizeColumn(13);
			xssf_w_sheet.autoSizeColumn(14);
			xssf_w_sheet.setColumnWidth((short) 15, (short) 8000); 
	 ...
	 * 
	 */
	public void expExcelaccount( String fileName,
			String sheetName, String[] titlesName, String[] sqlColumns,
			List<Map<String, Object>> dataList,OutputStream os) {
...
//			cellStyle_date.setDataFormat(HSSFDataFormat.getBuiltinFormat("yyyy/mm/dd"));
			...
			xssf_w_sheet.setColumnWidth((short) 1, (short) 5000); 
			xssf_w_sheet.autoSizeColumn(2); 
			xssf_w_sheet.autoSizeColumn(3);
			xssf_w_sheet.setColumnWidth((short) 4, (short) 5000); 
			xssf_w_sheet.setColumnWidth((short) 5, (short) 5000); 
			xssf_w_sheet.autoSizeColumn(6);
			xssf_w_sheet.autoSizeColumn(7);
			xssf_w_book.write(os);
			os.flush();
	 ...
	 * 
	 */
	public void expExcelorder( String fileName,
			String sheetName, String[] titlesName, String[] sqlColumns,
			List<Map<String, Object>> dataList,OutputStream os) {
		try {
			XSSFWorkbook xssf_w_book = new XSSFWorkbook();
...
//			cellStyle_date.setDataFormat(HSSFDataFormat.getBuiltinFormat("yyyy/mm/dd"));
			...
			xssf_w_sheet.autoSizeColumn(4);
			xssf_w_sheet.autoSizeColumn(5);
			xssf_w_sheet.setColumnWidth((short) 6, (short) 5000); 
			xssf_w_sheet.autoSizeColumn(7);
			xssf_w_sheet.autoSizeColumn(8);
			xssf_w_book.write(os);
			os.flush();
			os.close();
	...
	public void expExcelsearch( String fileName,
			String sheetName, String[] titlesName, String[] sqlColumns,
			List<Map<String, Object>> dataList,OutputStream os) {
