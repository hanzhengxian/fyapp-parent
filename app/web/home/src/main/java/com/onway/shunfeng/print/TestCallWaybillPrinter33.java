...
//        TestCallWaybillPrinter33.WayBillPrinterTools();
//
//    }
//
//    /*********2联单**************/
...
//     */
//    static String url1  = "http://localhost:4040/sf/waybill/print?type=V2.0_poster_100mm150mm&output=noAlertPrint";
//    /**
//     * 调用打印机 弹出窗口 可选择份数 适用于单张打印【二联单】
//     */
//    static String url2  = "http://localhost:4040/sf/waybill/print?type=V2.0_poster_100mm150mm&output=print";
//
//    /**
//     * 直接输出图片的BASE64编码字符串 可以使用html标签直接转换成图片【二联单】
//     */
//    static String url3  = "http://localhost:4040/sf/waybill/print?type=V2.0_poster_100mm150mm&output=image";
//
//    /*********3联单**************/
//    /**
//     * 调用打印机 不弹出窗口 适用于批量打印【三联单】
//     */
//    static String url4  = "http://localhost:4040/sf/waybill/print?type=V3.0_poster_100mm210mm&output=noAlertPrint";
//    /**
//     * 调用打印机 弹出窗口 可选择份数 适用于单张打印【三联单】
//     */
//    static String url5  = "http://localhost:4040/sf/waybill/print?type=V3.0_poster_100mm210mm&output=print";
//
//    /**
//     * 直接输出图片的BASE64编码字符串 可以使用html标签直接转换成图片【三联单】
//     */
//    static String url6  = "http://localhost:4040/sf/waybill/print?type=V3.0_poster_100mm210mm&output=image";
//
//    /*********2联150 丰密运单**************/
//    /**
//     * 调用打印机 不弹出窗口 适用于批量打印【二联单】
//     */
//    static String url7  = "http://localhost:4040/sf/waybill/print?type=V2.0.FM_poster_100mm150mm&output=noAlertPrint";
//    /**
//     * 调用打印机 弹出窗口 可选择份数 适用于单张打印【二联单】
//     */
//    static String url8  = "http://localhost:4040/sf/waybill/print?type=V2.0.FM_poster_100mm150mm&output=print";
//
//    /**
//     * 直接输出图片的BASE64编码字符串 可以使用html标签直接转换成图片【二联单】
//     */
//    static String url9  = "http://localhost:4040/sf/waybill/print?type=V2.0.FM_poster_100mm150mm&output=image";
//
//    /*********3联210 丰密运单**************/
//    /**
//     * 调用打印机 不弹出窗口 适用于批量打印【三联单】
//     */
//    static String url10 = "http://localhost:4040/sf/waybill/print?type=V3.0.FM_poster_100mm210mm&output=noAlertPrint";
//    /**
//     * 调用打印机 弹出窗口 可选择份数 适用于单张打印【三联单】
//     */
//    static String url11 = "http://localhost:4040/sf/waybill/print?type=V3.0.FM_poster_100mm210mm&output=print";
//
//    /**
//     * 直接输出图片的BASE64编码字符串 可以使用html标签直接转换成图片【三联单】
//     */
//    static String url12 = "http://localhost:4040/sf/waybill/print?type=V3.0.FM_poster_100mm210mm&output=image";
//
...
//
//        //这个必填 
//        dto.setAppId("SLKJ2019");//对应clientCode
//        dto.setAppKey("FBIqMkZjzxbsZgo7jTpeq7PD8CVzLT4Q");//对应checkWord
//
...
//
//        //        PrintSfOrder.print(waybillDtoList, "D:\\sfimg\\sf1\\", "D:\\sfimg\\sf2\\");
//
...
//                String fileName = "D:\\sfimg\\sf1\\qiaoWay" + dateStr + "-" + i + ".jpg";
//                Base64ImageTools.generateImage(arr[i].toString(), fileName);
//                files.add(fileName);
//
//            }
//        } else {
//            String fileName = "D:\\sfimg\\sf2\\qiaoWaybillHttpClient" + dateStr + ".jpg";
