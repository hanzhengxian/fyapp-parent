 ...
 * 
 * @author guangdong.li
 * @version $Id: SettlecoreResultCodeEnum.java, v 0.1 2015年10月30日 上午11:03:28
 *          liudehong Exp $
 */
public enum ResultCodeEnum implements EnumBase {
	...
	/** 平台码为空 */
	PLATFORMCODE_NULL("PLATFORMCODE_NULL", "平台码为空"),
	...
	/** 实名认证超过最大可认证次数,请联系客服! */
	CERTIFY_MORE_THAN_MAX_COUNT("CERTIFY_MORE_THAN_MAX_COUNT",
			" 实名认证超过最大可认证次数,请联系客服!"),
	...
	/** 充值回查的次数超过最长回查时间,请联系客服! */
	DEPOSIT_RECHECK_MORE_THAN_MAX_TIME("DEPOSIT_RECHECK_MORE_THAN_MAX_TIME",
			"充值回查的次数超过最长回查时间,请联系客服!"),
	/** 流水过渡过期变更状态为失败 */
	...
	// =============提现============
	/** 提现状态银行未返回,请联系客服! */
	WITHDRAW_RECHECK_MORE_THAN_MAX_COUNT(
			"WITHDRAW_RECHECK_MORE_THAN_MAX_COUNT", "提现状态银行未返回,请联系客服!"),
	 ...
	 *         如果存在返回相关值
	 */
	public static final ResultCodeEnum getByCode(String code) {
