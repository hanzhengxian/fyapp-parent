...
/**
 * An ibatis based implementation of dao interface <tt>com.onway.fyapp.common.dal.daointerface.OrderRefundLogDAO</tt>.
 *
 ...
 *
 * @author guangdong.li
 * @version $Id: IbatisOrderRefundLogDAO.java,v 1.0 2013/10/29 07:34:20 guangdong.li Exp $
 */
public class IbatisOrderRefundLogDAO extends SqlMapClientDaoSupport implements OrderRefundLogDAO {
	/**
    ...
    public  OrderRefundLogDO   selectByRefundNo(String refundNo) throws DataAccessException {
	        ...
	        return (OrderRefundLogDO) getSqlMapClientTemplate().queryForObject("MS-ORDER-REFUND-LOG-SELECT-BY-REFUND-NO", refundNo);
    ...
    public  int   newOrderRefund(OrderRefundLogDO orderRefundLog) throws DataAccessException {
        ...
        getSqlMapClientTemplate().insert("MS-ORDER-REFUND-LOG-NEW-ORDER-REFUND", orderRefundLog);

        return orderRefundLog.getId();
    }
    ...
    public  int   updateOrderRefund(OrderRefundLogDO orderRefundLog) throws DataAccessException {
        ...
        return getSqlMapClientTemplate().update("MS-ORDER-REFUND-LOG-UPDATE-ORDER-REFUND", orderRefundLog);
    }
